...
with(df, 
     {plot(DateTime, Global_active_power, ylab ="Global Active Power",type = 'l', xlab = " ")
       ...
       legend(x=mean(DateTime)+0.1*sd(DateTime), y=40, legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col = c("black","red","blue"), lty =1,y.intersp = 0.4, cex = 0.85, box.lty = 0)
